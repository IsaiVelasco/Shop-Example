function addNav(){
    ...
    divNav.innerHTML = 
    `
    <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900" style="float: right;" >
    ...
    <aside class="fixed top-0 left-0 w-64 h-full" aria-label="Sidenav" style="float: left;">
